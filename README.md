...
**A Master Artificer** is a distinctive static portfolio theme with a workspace-inspired presentation designed to highlight projects, skills, experience, and professional identity.
...
The visual direction draws from developer workspaces, technical dashboards, command-line tools, organized project documentation, and desktop-style interfaces. The theme should remain useful and intentional rather than decorative for decoration's sake.
...
| Color | Primary Use |
| --- | --- |
| `#D4CBB3` | Used throughout the theme styling |
| `#FFF` | Used throughout the theme styling |
| `#9CA3AF` | Used throughout the theme styling |
| `#2DD4BF` | Used throughout the theme styling |
| `#051517` | Used throughout the theme styling |
| `#0A2A2E` | Used throughout the theme styling |
| `#F4ECD8` | Used throughout the theme styling |
| `#E5E7EB` | Used throughout the theme styling |
| `#5C0000` | Used throughout the theme styling |
| `#8B0000` | Used throughout the theme styling |
...
| `blogindex.html` | Writing archive and article index |
...
| Component | Purpose |
| --- | --- |
| `components/AstrolabeNav.js` | Provides shared navigation behavior |
| `components/CustomCursor.js` | Controls themed cursor behavior |
| `components/PageChrome.js` | Provides shared layout and page framing |

### Shared Site Assets

| Asset | Purpose |
| --- | --- |
| `assets/About.js` | Shared site script |
| `assets/Article.js` | Shared site script |
| `assets/BlogIndex.js` | Shared site script |
| `assets/CaseStudies.js` | Shared site script |
| `assets/Contact.js` | Shared site script |
| `assets/Home.js` | Shared site script |
| `assets/main.css` | Main stylesheet and visual presentation |
| `assets/main.js` | Main site script |
| `assets/Projects.js` | Shared site script |
| `assets/proxy.js` | Shared supporting script |
| `assets/Skills.js` | Shared site script |
| `assets/Testimonials.js` | Shared site script |
| `assets/use-transform.js` | Shared site script |
| `assets/Work.js` | Shared site script |

### Theme-Specific Interactive Behavior

- `components/AstrolabeNav.js` supports the shared interface presentation.
- `components/CustomCursor.js` supports the shared interface presentation.
- `components/PageChrome.js` supports the shared interface presentation.
...
```text
a-master-artificer-github-pages-theme/
├── .github/
│   └── ISSUE_TEMPLATE/
│       ├── bug_report.md
│       ├── custom.md
...
├── images/
│   └── screenshots/
│       └── a-master-artificer-preview-placeholder.svg
├── .nojekyll
├── about.html
├── article.html
├── blogindex.html
...
- Portfolio sections remain available through `about.html`, `article.html`, `blogindex.html`, `casestudies.html`, `contact.html`, `projects.html`, `skills.html`, `testimonials.html`, `work.html`.
...
```text
https://apursley2012.github.io/a-master-artificer-github-pages-theme/
```
...
[Report an issue or request an addition](https://github.com/apursley2012/a-master-artificer-github-pages-theme/issues/new/choose)
